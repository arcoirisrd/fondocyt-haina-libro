...
<!-- TODO diagrama J-04-10: Jerarquía de instrumentos de ordenamiento territorial (PNOT → PROT/PEOT → PMOT → PPOT/PDU → Licencias y SNIT) siguiendo patrón matplotlib v5. Script pendiente en _recursos/diagramas/planificacion_jerarquia_instrumentos.py. -->
