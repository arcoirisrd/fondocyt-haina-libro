...
La formulación de la normativa urbanística y de gestión de riesgos para el municipio de Bajos de Haina se desarrolló entre el 1 de junio y el 8 de agosto de 2025, a cargo de los arquitectos Danilo Minaya, Yssamar Reyes y Anyerlina Hernández, con revisión y validación de la arquitecta Ana Moyano. El proceso articuló insumos geoespaciales, levantamiento de campo y validación institucional y comunitaria para producir una propuesta normativa diferenciada por tipología de manzana.
...
![Línea de tiempo del desarrollo normativo del **OE3**: seis fases entre junio y agosto de 2025, con duración, productos técnicos y actores por fase. Elaboración propia.](img/oe3/cap10_fases_normativa.png){#fig-fases-normativa-10}
...
El material complementario de esta actividad (hojas resumen de análisis fotogramétrico por manzana, resultados de la encuesta Survey123, capturas del dashboard geoespacial en ArcGIS Online, documento completo de propuesta normativa urbanística y presentación de socialización con el Ayuntamiento) se conserva como referencia documental en el repositorio del proyecto, dentro del entregable del **OE3** Actividades Normativa.

## Síntesis {#sec-sintesis-10}

El capítulo sistematiza las actividades ejecutadas entre el 1 de junio y el 8 de agosto de 2025 para formular la normativa urbanística del **OE3** por tipología de manzana en Bajos de Haina. El proceso se organizó en seis fases progresivas que articularon análisis fotogramétrico y LIDAR, levantamiento de edificaciones con Survey123, sistematización en Dashboard de ArcGIS Online, redacción normativa diferenciada y validación institucional y comunitaria con el Ayuntamiento y las juntas de vecinos.

Los resultados concretos son cinco: dieciséis manzanas sistematizadas con datos geoespaciales y levantamiento técnico detallado; plataforma interactiva con Dashboard operativo; propuesta normativa alineada con la Ley 368-22 y el Decreto 396-25; seis fichas normativas diferenciadas por tipología de manzana con parámetros cuantitativos verificables; y proceso validado mediante actas firmadas por el Ayuntamiento y representantes comunitarios. Los indicadores de seguimiento por fase y el cronograma general documentan el cumplimiento íntegro de las metas en el plazo previsto.

Las lecciones aprendidas confirman que la integración tecnológica (LIDAR, drones, SIG), la coproducción con juntas de vecinos, la diferenciación normativa por tipología y la sistematización en plataformas digitales son condiciones necesarias para producir normativa urbanística adaptada a contextos de informalidad. Las recomendaciones apuntan al escalamiento de la metodología como política pública, el fortalecimiento de capacidades municipales en SIG y procesamiento LIDAR, la institucionalización de la participación como paso vinculante en la formulación normativa, el establecimiento de un sistema de seguimiento georreferenciado interoperable y la promoción de convenios interinstitucionales con IGN y ONE que garanticen la actualización continua de los datos.
